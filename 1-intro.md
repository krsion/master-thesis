...
[@Chap:background] covers CRDTs, OT, and related work. [@Chap:implementation] presents the mydenicek CRDT. [@Chap:system] describes the implementation. [@Chap:evaluation] demonstrates formative examples and evaluates correctness and performance. [@Chap:conclusion] concludes with future work.
