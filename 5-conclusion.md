...
The system was validated on five formative examples and 337 tests (including property-based convergence testing). All examples are available as interactive demos at <https://krsion.github.io/mydenicek>.
