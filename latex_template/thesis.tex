...
\usepackage[natbib,style=$biblatex_citation_style$,sorting=none,backend=bibtex]{biblatex}
...
$for(additional_packages)$
\usepackage{$additional_packages$}
$endfor$
$endif$
