...
\def\ThesisTitleXmff{%
  \ifEN
    \centerline{\mbox{\includegraphics[width=166mm]{latex_img/logo-en.pdf}}}
  \else
    \centerline{\mbox{\includegraphics[width=166mm]{latex_img/logo-cs.pdf}}}
  \fi
  \vspace{-8mm}\vfill%
...
\def\ThesisTitleCuniLogo#1{%
  ...
  \vfill%
  \Department\par}
\def\ThesisTitleXcuni{\ThesisTitleCuniLogo{latex_img/uklogo.pdf}}
\def\ThesisTitleXnatur{\ThesisTitleCuniLogo{latex_img/naturlogo.pdf}}
...
\ifEN\nobreak\vbox to 0.95\vsize{\InfoPageFont
\setlength\parindent{0mm}
\setlength\parskip{5mm}
...
\Supervisor, $supervisors-department-cs$

Abstrakt:
\AbstractCS

Klíčová slova:
$for(keywords-cs)$$keywords-cs$$sep$, $endfor$
