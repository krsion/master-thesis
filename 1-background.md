...
The framework assumes *reliable causal broadcast* [@baquero2017pureop, §3]: delivery is causal (if $a \to b$, then $a$ is delivered before $b$), and every operation is eventually delivered.
